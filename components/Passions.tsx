// components/Passions.tsx - SEAMLESS FLOW
import { motion } from "framer-motion";

const passions = [
  { title: "Gaming", desc: "Exploring immersive worlds and strategy. I strive to optimize stats and search for the best outputs that we can possibly achieve.", icon: "🎮", color: "#F7A8B8" },
  { title: "Music", desc: "From classical piano to electronic music production. As an 8-year former musician, music holds an important place in my life, providing inspiration and outlet.", icon: "🎵", color: "#FFB347" },
  { title: "Asian Culture", desc: "Japanese and Chinese traditions & media. I am particularly attracted by how they blend history with modernity.", icon: "🏮", color: "#CBB3EE" },
  { title: "Stats & Logic", desc: "Mathematics, optimization, and AI models. I enjoy tackling complex problems and finding efficient solutions.", icon: "📊", color: "#F7A8B8" },
];
