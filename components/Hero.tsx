...
export default function Hero() {
  return (
    <section id="hero" className="section-container justify-center text-center px-6 relative">
      ...
      >
        <motion.h1 
          className="text-6xl md:text-8xl font-extrabold mb-8 leading-tight text-gray-900 dark:text-white"
        ...
        <motion.p 
          className="text-xl md:text-3xl mb-12 text-gray-700 dark:text-gray-200"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <motion.a
            href="#about"
            className="px-10 py-4 bg-transparent border-2 border-orange-400 text-gray-800 dark:text-gray-200 rounded-xl hover:bg-orange-400 hover:text-white text-lg font-semibold transform transition-all duration-300"
            whileHover={{ 
              scale: 1.05,
