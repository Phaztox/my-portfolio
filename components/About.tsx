...
export default function About() {
  return (
    <section id="about" className="section-container px-8 relative">
      <div className="max-w-5xl mx-auto text-center relative z-10 w-full">
        <h2 className="text-5xl font-bold mb-12 text-gray-900 dark:text-white">
          About Me
        </h2>
        
        <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-lg rounded-3xl p-12 border border-gray-200/30 dark:border-slate-600/30 shadow-2xl">
