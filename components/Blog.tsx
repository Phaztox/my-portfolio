    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 w-full">
        ...
        <div className="space-y-6">
          <motion.article 
            className={`backdrop-blur-sm responsive-card-radius responsive-card-padding shadow-lg hover:shadow-xl transition-shadow duration-300 ${
              darkMode 
          ...
          >
            <Link href="/blog/the-compressed-truth" className="block group">
              <h3 className={`font-semibold text-responsive-card-title mb-2 transition-colors duration-200 ${
                darkMode 
